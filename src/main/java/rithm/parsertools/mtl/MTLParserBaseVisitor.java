...
/**
 * This class provides an empty implementation of {@link MTLParserVisitor},
...
public class MTLParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements MTLParserVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitUnaryTemporal(@NotNull MTLParserParser.UnaryTemporalContext ctx) { return visitChildren(ctx); }
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitInterval(@NotNull MTLParserParser.IntervalContext ctx) { return visitChildren(ctx); }
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitBinaryNonTemporal(@NotNull MTLParserParser.BinaryNonTemporalContext ctx) { return visitChildren(ctx); }
}